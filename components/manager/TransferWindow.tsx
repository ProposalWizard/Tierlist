      ...
      <div className="max-w-2xl mx-auto px-4 py-5">
          ...
          <div className="space-y-4">
            {activity.length > 0 && (
              <div className="bg-gray-900 rounded-xl border border-gray-800/50 p-3">
                <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">Recent Activity</h3>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-[10px] text-gray-500 mt-1">Browse the market for a new addition</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-[10px] text-gray-500 mt-1">Free up budget — sells at 70% of value</div>
              </button>
            </div>

            <div className="bg-gray-900 rounded-xl border border-gray-800/50 p-4">
              <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">Current Squad ({squad.length}/14)</h3>
        ...
        {view === "sell" && (
          <div className="space-y-2">
            <button onClick={() => setView("hub")} className="text-xs text-gray-500 hover:text-gray-300 mb-3">← Back</button>
            <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">Tap a player to sell</h3>
            <div>
              ...
              {starters.map(p => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[10px] text-gray-600">{p.clubYear} · {p.overall} OVR</div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-black text-emerald-400">£{Math.round(playerPrice(p.overall) * 0.7)}M</div>
                    <div className="text-[9px] text-gray-600">sell value</div>
                  </div>
                </button>
              ))}
        ...
        {view === "buy" && (
          <div className="space-y-3">
            <button onClick={() => { setView("hub"); setReplaceTarget(null); setMarketOptions(null); }} className="text-xs text-gray-500 hover:text-gray-300 mb-3">← Back</button>
            {replaceTarget && (
            ...
            {marketOptions && (
              <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-gray-500 mt-0.5">{mp.club} · {mp.year}</div>
                        </div>
                        <div className="text-right">
                ...
                <button onClick={() => loadMarketFor(replaceTarget)} className="w-full text-xs text-gray-500 hover:text-gray-300 py-2">↻ Scout again</button>
              </div>
            )}
          </div>
        )}
