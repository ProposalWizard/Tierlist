    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 pb-32">
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="text-center mb-5">
          ...
          <p className="text-gray-500 text-xs mt-1">Tap two players to swap positions</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-5">
          ...
          <div className="bg-gray-900 rounded-lg p-3 border border-gray-800/50 text-center">
            <div className="text-[9px] text-gray-600 uppercase tracking-wider">Starters</div>
            <div className="text-xl font-black text-emerald-400">{starterAvg}</div>
          </div>
          <div className="bg-gray-900 rounded-lg p-3 border border-gray-800/50 text-center">
            <div className="text-[9px] text-gray-600 uppercase tracking-wider">Budget Left</div>
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800/50 p-4">
          <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-3">Substitutes</h3>
