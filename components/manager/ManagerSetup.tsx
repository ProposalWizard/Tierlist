    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950">
      ...
      <div className="border-b border-gray-900/50 backdrop-blur-sm sticky top-0 z-10 bg-black/60">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/" className="text-xs text-white hover:text-gray-400 transition-colors">← knowitball</Link>
          <Link href="/draft" className="text-xs text-white hover:text-gray-400 transition-colors">draft mode →</Link>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-900/50 rounded-2xl border border-gray-800/50 p-5 mb-6">
          <h3 className="text-[10px] font-bold tracking-widest text-white uppercase mb-3">How it works</h3>
          <div className="space-y-2.5 text-sm">
            <div className="flex gap-3">
              <span className="text-amber-400 font-black">1</span>
              <div className="text-white">Build your XI + 3 subs in the <span className="text-white font-semibold">Transfer Market</span> using a £500M budget.</div>
            </div>
            <div className="flex gap-3">
              <span className="text-amber-400 font-black">2</span>
              <div className="text-white">Play through the season — <span className="text-white font-semibold">live match events</span> with goals, fouls, near misses.</div>
            </div>
            <div className="flex gap-3">
              <span className="text-amber-400 font-black">3</span>
              <div className="text-white">Make subs at <span className="text-white font-semibold">halftime</span> — fresh legs get a chance bonus.</div>
            </div>
            <div className="flex gap-3">
              <span className="text-amber-400 font-black">4</span>
              <div className="text-white">Mid-season <span className="text-white font-semibold">transfer window</span> — buy and sell to reshape the squad.</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800/50 p-5 mb-6">
          <h3 className="text-[10px] font-bold tracking-widest text-white uppercase mb-3">Formation</h3>
