      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm mt-2">Strength rating · {opponent.strength}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-900/50 rounded-2xl p-6 mb-5 border border-gray-800/50">
            <div className="flex items-center justify-around">
              <div className="text-center">
                ...
                <div className="text-[10px] text-gray-600 mt-0.5">Avg OVR</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-[10px] text-gray-600 mt-0.5">Rating</div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="text-center min-w-[60px]">
              <div className={`text-2xl font-black ${phase === "fulltime" ? "text-gray-500" : "text-emerald-400"}`}>
        ...
        <div className="flex-1 overflow-auto p-4">
          <div className="max-w-md mx-auto">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">Currently On</h3>
              ...
              <div>
                <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">Bench</h3>
                <div className="space-y-1.5">
                  {subs.map(p => {
            ...
            <div className="max-w-md w-full text-center">
              <div className={`inline-block px-4 py-1.5 rounded-full border mb-4 ${
                ...
                <span className={`text-xs font-black tracking-widest uppercase ${
                  ...
                  goalsFor < goalsAgainst ? "text-red-400" : "text-gray-400"
                }`}>
              ...
              <p className="text-gray-500 text-sm mb-6">{isHome ? "Home" : "Away"} · vs {opponent.name}</p>

              {result.scorers.length > 0 && (
                <div className="bg-gray-900 rounded-xl border border-gray-800 p-4 mb-6">
                  <h3 className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">Scorers</h3>
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto max-w-2xl mx-auto w-full px-4 pb-6">
          <div className="space-y-2 pt-3">
            {shownEvents.length === 0 && (
              <div className="text-center text-gray-700 text-xs py-12">Match underway...</div>
            )}
            {shownEvents.map((e, i) => {
              ...
              return (
                ...
                >
                  <div className="shrink-0 w-10 text-center">
                    <div className={`text-xs font-black ${isGoal ? "text-white" : "text-gray-500"}`}>{e.minute}'</div>
