      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="relative flex-1">
          ...
          {query && (
            <button
              onClick={() => setQuery("")}
              className="absolute inset-y-0 right-3 flex items-center text-white hover:text-white"
            >
              ×
            </button>
          )}
            ...
            return (
              ...
              >
                ...
                <div className="p-2.5">
                  ...
                  {item.category && (
                    <p className="mt-0.5 truncate text-[10px] text-white">{item.category}</p>
                  )}
                  {item.creator && (
                    <p className="mt-0.5 truncate text-[10px] text-white">by {item.creator}</p>
                  )}
                  <div className="mt-1.5 flex items-center justify-between text-[10px] text-white">
