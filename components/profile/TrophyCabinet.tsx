    ...
    <div className="rounded-xl border border-gray-800/50 bg-gray-900 p-4">
          ...
          <button
            ...
            className={`text-[10px] font-bold px-2.5 py-1 rounded-lg transition-colors ${
              filter === f.key
                ...
                : "text-gray-200 hover:text-gray-300 border border-transparent"
            }`}
          >
            {f.label}
          </button>
          ...
          return (
            ...
            >
              ...
              <span className={`text-[9px] font-bold text-center leading-tight truncate w-full ${
                reward.unlocked ? rarity.text : "text-gray-300"
              }`}>
      ...
      {filtered.length > INITIAL_VISIBLE && (
        <button
          ...
          className="w-full mt-3 py-2 text-[11px] font-bold text-gray-200 hover:text-gray-300 border border-gray-800/60 hover:border-gray-700/60 rounded-lg transition-colors"
        >
              ...
              return (
                <>
                  <div className="text-center mb-4">
                    ...
                    <h4 className={`text-lg font-black ${selectedReward.unlocked ? rarity.text : "text-gray-200"}`}>
                      ...
                      {selectedReward.category === "frame" && (
                        <div className="mt-3 flex justify-center">
                          <div className={`w-24 h-16 rounded-lg ${FRAME_STYLES[selectedReward.id]?.border ?? "border-2 border-gray-700"} ${FRAME_STYLES[selectedReward.id]?.shadow ?? ""} bg-gray-800 flex items-center justify-center`}>
                            <span className="text-[9px] text-gray-200 font-bold">Preview</span>
                          </div>
                        </div>
                      )}
                    </>
