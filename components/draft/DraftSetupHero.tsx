...
// Hybrid setup: V2 hero image at the top, standard DraftSetup body below.
// Used by /draft-dev2 for testing the new hero design.
...
export default function DraftSetupHero({ onStart, onCreateRoom, onJoinRoom, teamName, onTeamNameChange }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#07090d] text-white">
      ...
      {/* ═════════════════ V2 HERO — player image + PREMIER LEAGUE DRAFT ═════════════════ */}
      ...
      {/* ═════════════════ REST OF LAYOUT — copied verbatim from DraftSetup ═════════════════ */}
      <div className="flex flex-col items-center px-3 sm:px-4 py-6">
