...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      { position: "GK", label: "GK", x: 50, y: 92, compatiblePositions: ["GK"] },
      { position: "CB", label: "CB", x: 72, y: 65, compatiblePositions: ["CB", "RB"] },
      { position: "CB", label: "CB", x: 50, y: 65, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 28, y: 65, compatiblePositions: ["CB", "LB"] },
      { position: "RM", label: "RM", x: 88, y: 40, compatiblePositions: ["RM", "RW", "RWB", "RB"] },
      { position: "CM", label: "CM", x: 65, y: 42, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "CM", label: "CM", x: 50, y: 44, compatiblePositions: ["CM", "CDM"] },
      { position: "CM", label: "CM", x: 35, y: 42, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "LM", label: "LM", x: 12, y: 40, compatiblePositions: ["LM", "LW", "LWB", "LB"] },
      { position: "ST", label: "ST", x: 60, y: 18, compatiblePositions: ["ST", "CF", "RW"] },
      { position: "ST", label: "ST", x: 40, y: 18, compatiblePositions: ["ST", "CF", "LW"] },
    ],
  },
  {
    name: "3-4-3",
    slots: [
      ...
      { position: "CB", label: "CB", x: 50, y: 65, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 28, y: 65, compatiblePositions: ["CB", "LB"] },
      { position: "RM", label: "RM", x: 85, y: 40, compatiblePositions: ["RM", "RW", "RWB"] },
      { position: "CM", label: "CM", x: 62, y: 44, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "CM", label: "CM", x: 38, y: 44, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "LM", label: "LM", x: 15, y: 40, compatiblePositions: ["LM", "LW", "LWB"] },
      { position: "RW", label: "RW", x: 78, y: 18, compatiblePositions: ["RW", "RM", "ST", "CF"] },
      { position: "ST", label: "ST", x: 50, y: 13, compatiblePositions: ["ST", "CF"] },
      { position: "LW", label: "LW", x: 22, y: 18, compatiblePositions: ["LW", "LM", "ST", "CF"] },
    ],
  },
  {
    name: "4-1-4-1",
  ...
  },
  {
    ...
    slots: [
      { position: "GK", label: "GK", x: 50, y: 92, compatiblePositions: ["GK"] },
      { position: "RWB", label: "RWB", x: 88, y: 58, compatiblePositions: ["RWB", "RB", "RM"] },
      { position: "CB", label: "CB", x: 68, y: 65, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 50, y: 65, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 32, y: 65, compatiblePositions: ["CB"] },
      { position: "LWB", label: "LWB", x: 12, y: 58, compatiblePositions: ["LWB", "LB", "LM"] },
      { position: "CM", label: "CM", x: 65, y: 44, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "CM", label: "CM", x: 50, y: 46, compatiblePositions: ["CM", "CDM"] },
      { position: "CM", label: "CM", x: 35, y: 44, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "ST", label: "ST", x: 60, y: 20, compatiblePositions: ["ST", "CF"] },
      { position: "ST", label: "ST", x: 40, y: 20, compatiblePositions: ["ST", "CF"] },
    ],
  },
];
