...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      { position: "GK", label: "GK", x: 50, y: 92, compatiblePositions: ["GK"] },
      { position: "CB", label: "CB", x: 72, y: 72, compatiblePositions: ["CB", "RB"] },
      { position: "CB", label: "CB", x: 50, y: 72, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 28, y: 72, compatiblePositions: ["CB", "LB"] },
  ...
  },
  {
    ...
    slots: [
      { position: "GK", label: "GK", x: 50, y: 92, compatiblePositions: ["GK"] },
      { position: "RWB", label: "RWB", x: 88, y: 62, compatiblePositions: ["RWB", "RB", "RM"] },
      { position: "CB", label: "CB", x: 68, y: 72, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 50, y: 72, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 32, y: 72, compatiblePositions: ["CB"] },
      { position: "LWB", label: "LWB", x: 12, y: 62, compatiblePositions: ["LWB", "LB", "LM"] },
