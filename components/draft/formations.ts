...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { position: "RM", label: "RM", x: 88, y: 46, compatiblePositions: ["RM", "RW", "RWB", "RB"] },
      ...
      { position: "LM", label: "LM", x: 12, y: 46, compatiblePositions: ["LM", "LW", "LWB", "LB"] },
      { position: "ST", label: "ST", x: 60, y: 20, compatiblePositions: ["ST", "CF", "RW"] },
      { position: "ST", label: "ST", x: 40, y: 20, compatiblePositions: ["ST", "CF", "LW"] },
    ],
  },
  {
    name: "3-4-3",
    slots: [
      ...
      { position: "CB", label: "CB", x: 50, y: 65, compatiblePositions: ["CB"] },
      { position: "CB", label: "CB", x: 28, y: 65, compatiblePositions: ["CB", "LB"] },
      { position: "RM", label: "RM", x: 85, y: 45, compatiblePositions: ["RM", "RW", "RWB"] },
      { position: "CM", label: "CM", x: 62, y: 48, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "CM", label: "CM", x: 38, y: 48, compatiblePositions: ["CM", "CDM", "CAM"] },
      { position: "LM", label: "LM", x: 15, y: 45, compatiblePositions: ["LM", "LW", "LWB"] },
      { position: "RW", label: "RW", x: 78, y: 20, compatiblePositions: ["RW", "RM", "ST", "CF"] },
      { position: "ST", label: "ST", x: 50, y: 15, compatiblePositions: ["ST", "CF"] },
      { position: "LW", label: "LW", x: 22, y: 20, compatiblePositions: ["LW", "LM", "ST", "CF"] },
    ],
  },
  {
    name: "4-1-4-1",
