// ══════════════════════════════════════════════════════════════════════════
// TEST-ONLY FORK of hiddenMatch.ts, for /star-match-dev — see the banner atop
// canvasEngineTest.ts. Changes here do not reach live play at /star-dev.
// ══════════════════════════════════════════════════════════════════════════

import type { ScenarioKind } from "@/lib/star/canvasEngineTest";
