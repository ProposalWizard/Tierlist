...
export const DILEMMAS: Dilemma[] = [
  {
    ...
    choices: [
      { label: "Go out with the team", effects: { energy: -20, team: 8, boss: -3 }, narrative: "Great night — team bond stronger." },
      { label: "Stay in and rest", effects: { energy: 10, team: -3, boss: 2 }, narrative: "Fully rested for the weekend." },
    ],
  },
  {
    id: "media-interview",
  ...
  },
  {
    ...
    choices: [
      { label: "Attend", effects: { energy: -8, fans: 10, fame: 4, sponsors: 3 }, narrative: "Coverage everywhere. Kids loved it." },
  ...
  },
  {
    ...
    choices: [
      { label: "Agree — I'll work harder", effects: { boss: 8, energy: -5 }, narrative: "He nods. Good response." },
  ...
  },
  {
    ...
    choices: [
      { label: "Do the shoot", effects: { energy: -12, money: 5, sponsors: 6, fame: 3 }, narrative: "Long day but the paycheque's decent." },
  ...
  },
  {
    ...
    choices: [
      { label: "Attend", effects: { energy: -18, technique: 2 }, narrative: "Solid session — you feel sharper." },
      { label: "Skip", effects: {} },
    ],
  },
  {
    ...
    choices: [
      { label: "Stop and sign", effects: { fans: 8, energy: -2 }, narrative: "You made their day." },
  ...
  },
  {
    ...
    choices: [
      { label: "Take them out", effects: { money: -4, energy: -6, happiness: 10 }, narrative: "Great evening." },
  ...
  },
  {
    ...
    choices: [
      { label: "Visit them", effects: { energy: -8, fans: 15, fame: 6, happiness: 8 }, narrative: "Beautiful moment. Cameras were there too." },
  ...
  },
  {
    ...
    choices: [
      { label: "Push through", effects: { energy: -12, matchFitness: 4, technique: 1 } },
      { label: "Ease off, ice it", effects: { energy: 5, matchFitness: -8, boss: -2 } },
    ],
  },
  {
    id: "captain-argument",
  ...
  },
  {
    ...
    choices: [
      { label: "Play a few hands", effects: { money: -5, team: 4, energy: -6 }, narrative: "Small loss but you fit in." },
  ...
  },
  {
    ...
    choices: [
      { label: "Do the campaign", effects: { energy: -12, money: 20, sponsors: 10, fame: 8 }, narrative: "Big paycheque and coverage." },
  ...
  },
  {
    ...
    choices: [
      { label: "Coffee and power through", effects: { energy: -5, boss: -1 } },
      { label: "Ask to skip the session", effects: { energy: 10, boss: -6 } },
    ],
  },
  {
    id: "youth-team-visit",
    ...
    choices: [
      { label: "Do it happily", effects: { boss: 5, fans: 4, energy: -4 } },
...
export function applyEffects(career: CareerState, effects: DilemmaEffect): CareerState {
  ...
  if (effects.energy !== undefined) next.energy = clamp(next.energy + effects.energy);
