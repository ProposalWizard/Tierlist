...
export const DEFAULT_PL_TEAMS: { name: string; strength: number }[] = [
  ...
  { name: 'Leeds', strength: 77 },
  { name: 'Coventry', strength: 75 },
  { name: 'Ipswich', strength: 74 },
  { name: 'Hull', strength: 73 },
];

export const RESERVE_TEAMS: { name: string; strength: number }[] = [
  { name: 'Wolves', strength: 75 },
  { name: 'Millwall', strength: 75 },
  { name: 'Southampton', strength: 75 },
  { name: 'Middlesbrough', strength: 75 },
  { name: 'Wrexham', strength: 75 },
  { name: 'Burnley', strength: 74 },
  { name: 'West Ham', strength: 74 },
  { name: 'Stoke', strength: 74 },
  { name: 'Norwich', strength: 74 },
  { name: 'Swansea', strength: 74 },
  { name: 'Sheffield', strength: 74 },
  { name: 'Watford', strength: 74 },
];
