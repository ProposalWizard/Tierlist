  ...
  if (loading) {
    return (
      <div className="max-w-2xl mx-auto p-4 pb-20">
        <Link href="/draft" className="inline-flex items-center gap-1 text-sm font-bold text-gray-300 hover:text-white bg-gray-800 hover:bg-gray-700 border border-gray-700/50 rounded-lg px-3 py-1.5 transition mb-4">
          &larr; Back to Draft
        </Link>
